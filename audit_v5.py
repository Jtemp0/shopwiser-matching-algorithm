"""
ShopWiser Cluster Audit v5
==========================
Uses Claude claude-sonnet-4-5 to evaluate each cluster in audit_sample_50.csv.
For each cluster, asks: "Are all these products the same core product?"
Reports pass/fail per cluster and overall pass rate.

Usage:
    ANTHROPIC_API_KEY=sk-... python audit_v5.py
"""
...
INPUT_CSV  = f'{DATA_DIR}/audit_sample_50.csv'
OUTPUT_CSV = f'{DATA_DIR}/audit_results_v5.csv'
MODEL      = 'claude-sonnet-4-5'
PASS_THRESHOLD = 0.90   # target
